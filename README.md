...
Click "+ Add Student" to register a new student (e.g., Alice).

Click "+ Create Subject" to add a subject (e.g., "Physics").

Select Alice from the list.

Select Physics from the dropdown.

Select "Create New..." in the assessment dropdown.

Enter Title, Score, and Feedback, then click Add Assessment.

Logout and log in as Alice (using the credentials you just created) to see the chart!
